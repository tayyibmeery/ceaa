                    ...
                    <div class="card-body">
                      ...
                      ">
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ asset('storage/'.$application->user->profile_picture) }}" alt="Profile Picture" style="width: 50px; height: 50px; object-fit: cover;">
                                        @else
                                        N/A
                                        @endif
                                    </td>
                    ...
                    <div class="card-body">
                      ...
                      ">
                                        ...
                                        <td>
                                            ...
                                            <!-- Display Image -->
                                            <img src="{{ asset('storage/'.$application->fees_receipt) }}" alt="Fees Receipt" style="width: 100px; height: auto; object-fit: cover;">
                                            @elseif(strtolower($fileExtension) == 'pdf')
                                            <!-- Display PDF Link -->
                                            <a href="{{ asset('storage/'.$application->fees_receipt) }}" target="_blank" class="btn btn-info btn-sm">View PDF</a>
                                            @else
...
<section class="content">
    ...
    @if($application->fees_receipt)
        ...
        @if(in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg']))
            ...
            <img src="{{ asset('storage/'.$application->fees_receipt) }}" alt="Fees Receipt" style="width: 50px; height: 50px; object-fit: cover;">
            <button type="button" class="btn btn-primary btn-sm view-image" data-img="{{ asset('storage/'.$application->fees_receipt) }}">View</button>

        @elseif(strtolower($fileExtension) == 'pdf')
            <!-- Show PDF view button -->
            <a href="{{ asset('storage/'.$application->fees_receipt) }}" target="_blank" class="btn btn-info btn-sm">View </a>
