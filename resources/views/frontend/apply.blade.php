								...
								<div class="container">
												...
												<div class="card shadow-sm">
																<div class="card-body p-4">
																				...
																				@else
																								<form action="{{ route("postsjob.apply", $jobPost->id) }}" method="POST"
																												...
																												<div class="row mb-4">
																																<div class="col-12 text-center">
																																				...
																																				<img src="{{ asset("storage/" . (auth()->user()->profile_picture ?? "default-profile.jpg")) }}"
																																								alt="Profile Picture"
																																								class="rounded-circle border-3 border-success mb-3 border shadow-sm"
																																				...
																																				<div class="row g-3">
																																								<div class="form-group col-6">
																																												...
																																												<input type="text" id="first_name" name="first_name"
																																																value="{{ auth()->user()->first_name }}" class="form-control readonly"
																																																readonly>
																																								</div>
																																								<div class="form-group col-6">
																																												<label for="last_name">Last Name:</label>
																																												<input type="text" id="last_name" name="last_name"
																																																value="{{ auth()->user()->last_name }}" class="form-control readonly"
																																																readonly>
																																								</div>
																																								<div class="form-group col-6">
																																												<label for="father_name">Father Name:</label>
																																												<input type="text" id="father_name" name="father_name"
																																																value="{{ auth()->user()->father_name }}" class="form-control readonly"
																																																readonly>
																																								</div>
																																								<div class="form-group col-6">
																																												<label for="dob">Date of Birth:</label>
																																												<input type="text" id="dob" name="dob"
																																																value="{{ auth()->user()->date_of_birth }}" class="form-control readonly"
																																																readonly>
																																								</div>
																																								...
																																								<div class="form-group col-6">
																																												...
																																												<input type="text" id="cnic" name="cnic"
																																																value="{{ auth()->user()->cnic }}" class="form-control readonly" readonly>
																																								</div>
																																								<div class="form-group col-6">
																																												<label for="phone">Phone Number:</label>
																																												<input type="text" id="phone" name="phone"
																																																value="{{ auth()->user()->phone }}" class="form-control readonly" readonly>
																																								</div>
																																								...
																																								<div class="form-group col-6">
																																												...
																																												<input type="text" id="province_of_domicile" name="province_of_domicile"
																																																value="{{ auth()->user()->province_of_domicile }}"
																																																class="form-control readonly" readonly>
																																								</div>

																																								<div class="form-group col-6">
																																												<label for="district_of_domicile">District of Domicile:</label>
																																												<input type="text" id="district_of_domicile" name="district_of_domicile"
																																																value="{{ auth()->user()->district_of_domicile }}"
																																																class="form-control readonly" readonly>
																																								</div>
																																								...
																																								<div class="form-group col-6">
																																												...
																																												<input type="text" id="postal_city" name="postal_city"
																																																value="{{ auth()->user()->postal_city }}" class="form-control readonly"
																																																readonly>
																																								</div>
																																...
																																<div class="card-body">
																																				<div class="row g-3">
																																								...
																																								<div class="col-md-4">
																																												...
																																												<input type="file" name="fees_receipt"
																																																class="form-control @error("fees_receipt") is-invalid @enderror"
																																																accept=".pdf,.jpg,.png">
																																												@error("fees_receipt")
																																																<div class="invalid-feedback">{{ $message }}</div>
																																												@enderror
