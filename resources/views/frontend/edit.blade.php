																								...
																								<div class="card-body text-center">
																												<div class="mb-3">
																																<img src="{{ asset("storage/" . (auth()->user()->profile_picture ?? "default-profile.jpg")) }}"
																																				class="rounded-circle mb-3 border border-2" width="150" height="150"
																																				id="preview-image">
																												</div>
																												<div class="mb-3">
																												...
																												<form action="{{ route("profile.update") }}" method="POST" enctype="multipart/form-data">
																																...
																																<div class="row g-3">
																																				...
																																				<div class="col-md-6">
																																								...
																																								<input type="text" class="form-control @error("cnic") is-invalid @enderror"
																																												name="cnic" value="{{ old("cnic", auth()->user()->cnic) }}"
																																...
																																<div class="row g-3">
																																				<div class="col-md-6">
																																								...
																																								<input type="text"
																																												class="form-control @error("province_of_domicile") is-invalid @enderror"
																																												name="province_of_domicile"
																																												value="{{ old("province_of_domicile", auth()->user()->province_of_domicile) }}">
																																				</div>
																																				<div class="col-md-6">
																																								<label class="form-label">District of Domicile</label>
																																								<input type="text"
																																												class="form-control @error("district_of_domicile") is-invalid @enderror"
																																												name="district_of_domicile"
																																												value="{{ old("district_of_domicile", auth()->user()->district_of_domicile) }}">
																																				</div>
																																				<div class="col-md-6">
																																								...
																																								<input type="text"
																																												...
																																												name="postal_city"
																																												value="{{ old("postal_city", auth()->user()->postal_city) }}">
																																				</div>
																																				<div class="col-md-6">
																																												...
																																												<div class="education-entry mb-3 rounded border p-3">
																																																<div class="row g-3">
																																																				<div class="col-md-6">
																																																								...
																																																								<input type="text"
																																																												class="form-control @error("educations." . $index . ".degree_title") is-invalid @enderror"
																																																				...
																																																				<div class="col-md-4">
																																																								...
																																																								<input type="text"
																																																												class="form-control @error("educations." . $index . ".grade_cgpa") is-invalid @enderror"
																																																												name="educations[{{ $index }}][grade_cgpa]"
