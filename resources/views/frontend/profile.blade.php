        ...
        <div class="mb-4 rounded bg-white p-4 shadow-sm">
            ...
            <div class="mb-5 text-center">
                <div class="position-relative d-inline-block mb-3">
                    <img src="{{ asset( (auth()->user()->profile_picture ?? "default-profile.jpg")) }}" alt="Profile Picture" class="rounded-circle border-3 border-success border shadow" style="width: 150px; height: 150px; object-fit: cover;">
                </div>
                                ...
                                <div class="list-group-item text-center">
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ asset( $post->advertisement_file) }}" class="btn btn-info btn-sm me-2">
                                                Download
                                            </a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-start">
                                            ...
                                            <br>
                                            <small class="text-muted">{{ $application->jobPost->organization_name }}</small>
                                        </td>
                                        <td>
                                            <!-- Status Badge -->
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <small class="d-block">
                                                    ...
                                                    <span class="badge {{ $application->payment_status === "paid" ? "badge-success" : "badge-warning" }}">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <a href="{{ asset( $application->resume) }}" class="btn btn-sm btn-outline-secondary me-1">
                                                    Resume
                                                </a>
                                                @endif
                                                @if ($application->cover_letter)
                                                <a href="{{ asset( $application->cover_letter) }}" class="btn btn-sm btn-outline-secondary me-1">
                                                    Cover Letter
                                                </a>
                                                @endif
                                                @if ($application->fees_receipt)
                                                <a href="{{ asset( $application->fees_receipt) }}" class="btn btn-sm btn-outline-secondary">
                                                    Receipt
                                                </a>
                                                @endif
                                            </div>
                            ...
                            <table class="table-sm table text-center align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $application->jobPost->title }}</td>
                                        <td>
                                            <span class="badge {{ $application->result->marks_obtained >= $application->result->total_marks / 2 ? "badge-success" : "badge-danger" }}">
                                                Score:
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4 text-center">
                                <div class="mb-3">
                                    <img src="{{ asset(auth()->user()->profile_picture ?? 'default-profile.jpg') }}" alt="avatar" class="rounded-circle border border-2" width="150" height="150">
                                </div>
