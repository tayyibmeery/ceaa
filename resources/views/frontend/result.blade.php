                ...
                <div class="card rounded-3 mb-4 border-0 shadow-sm">
                    <div class="card-header bg-success d-flex justify-content-between align-items-center py-3 text-white">
                        <div class="d-flex align-items-center">
                            <button class="btn btn-link text-decoration-none me-2 p-0 text-white" data-bs-toggle="collapse" data-bs-target="#resultContent{{ $result->id }}" aria-expanded="true">
                    ...
                    <div class="show collapse" id="resultContent{{ $result->id }}">
                        <div class="card-body p-4">
                            ...
                            <div class="mt-4 text-center">
                                <a href="{{ route("candidate_result.download", $result->id) }}" class="btn btn-success px-4">
