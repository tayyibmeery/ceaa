																				...
																				@if ($upcomingTests->count() > 0)
																								@foreach ($upcomingTests as $rollSlip)
																												<div class="card rounded-3 mb-4 border-0 shadow-sm">
																																<div
																																				...
																																				<div class="d-flex align-items-center">
																																								<button class="btn btn-link text-decoration-none me-2 p-0 text-white"
																																												data-bs-toggle="collapse" data-bs-target="#rollSlipContent{{ $rollSlip->id }}"
																																												aria-expanded="true">
																																...
																																<div class="show collapse" id="rollSlipContent{{ $rollSlip->id }}">
																																				<div class="card-body p-4">
																																								...
																																								<div class="rounded border p-3">
																																												...
																																												<p class="mb-0"><i
																																																				class="fas fa-map-marker-alt me-2"></i>{{ $rollSlip->test->test_center }}
																																												</p>
																																								</div>

																																								<!-- Download Button -->
																																								<div class="mt-4 text-center">
																																												<a href="{{ route("roll-number-slip.download", $rollSlip->id) }}"
