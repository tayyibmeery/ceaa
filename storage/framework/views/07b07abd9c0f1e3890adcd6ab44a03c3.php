												...
												<div class="mb-4 rounded bg-white p-4 shadow-sm">
																...
																<div class="mb-5 text-center">
																				<div class="position-relative d-inline-block mb-3">
																								<img src="<?php echo e(asset("storage/" . (auth()->user()->profile_picture ?? "default-profile.jpg"))); ?>"
																																								...
																																								<div class="list-group-item text-center">
																																												<div class="d-flex flex-column">
																																																...
																																																<div class="d-flex justify-content-center gap-2">
																																																				<a href="<?php echo e(asset("storage/" . $post->advertisement_file)); ?>"
																																																								class="btn btn-info btn-sm me-2">
																																																								Download
																																																				</a>
																																																				<a href="<?php echo e(route("postsjob.show", $post->id)); ?>"
																																								...
																																								<?php $__empty_1 = true; $__currentLoopData = auth()->user()->applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
																																												<tr>
																																																<td class="text-start">
																																																				...
																																																				<br>
																																																				<small
																																																								class="text-muted"><?php echo e($application->jobPost->organization_name); ?></small>
																																																</td>
																																																<td>
																																																				<!-- Status Badge -->
																																																				<span
																																																								class="badge <?php echo e($application->status === "pending" ? "badge-warning" : "badge-success"); ?>">
																																																				...
																																																				<div class="mt-2">
																																																								...
																																																								<?php if($application->payment_status): ?>
																																																												<small class="d-block">
																																																																...
																																																																<span
																																																																				class="badge <?php echo e($application->payment_status === "paid" ? "badge-success" : "badge-warning"); ?>">
																																																				...
																																																				<div class="mt-2">
																																																								...
																																																								<?php if($application->cover_letter): ?>
																																																												<a href="<?php echo e(asset("storage/" . $application->cover_letter)); ?>"
																																																																class="btn btn-sm btn-outline-secondary me-1">
																																																																Cover Letter
																																																												</a>
																																																								<?php endif; ?>
																																																								<?php if($application->fees_receipt): ?>
																																																												<a href="<?php echo e(asset("storage/" . $application->fees_receipt)); ?>"
																																								...
																																								<?php $__empty_1 = true; $__currentLoopData = auth()->user()->applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
																																												<?php if($application->result): ?>
																																																<tr>
																																																				...
																																																				<td>
																																																								<span
																																																												class="badge <?php echo e($application->result->marks_obtained >= $application->result->total_marks / 2 ? "badge-success" : "badge-danger"); ?>">
																																																												Score:
