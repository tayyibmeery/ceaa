            ...
            <div class="col-lg-8 col-md-10">
                <div class="card shadow-lg p-4">
                    <div class="widget clearfix widget-archive notificationSection">
                        ...
                        <?php endif; ?>
                        <!-- Search Form -->
                        <form action="<?php echo e(route('candidate_result.search')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CEAA\ceaa\resources\views/frontend/result_index.blade.php ENDPATH**/ ?>