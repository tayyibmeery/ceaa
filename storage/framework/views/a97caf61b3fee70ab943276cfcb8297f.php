...
<head>
    ...
    <title><?php echo $__env->yieldContent("title", "Elegant Testing Agency"); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(asset("frontend/images/logo.png")); ?>">

    <!-- Styles -->
    <link href="<?php echo e(asset("frontend/assets/css/plugins.css")); ?>" rel="stylesheet">
    <link href="<?php echo e(asset("frontend/assets/vendors/css/forms/select/select2.min.css")); ?>" rel="stylesheet">
    <link href="<?php echo e(asset("frontend/fonts/font-awesome/css/font-awesome.min.css")); ?>" rel="stylesheet">
    <link href="<?php echo e(asset("frontend/assets/css/style.css")); ?>" rel="stylesheet">
    <link href="<?php echo e(asset("frontend/assets/vendors/css/extensions/toastr.min.css")); ?>" rel="stylesheet">
    <link href="<?php echo e(asset("frontend/assets/css/notification.css")); ?>" rel="stylesheet">
...
<body class="breakpoint-lg b--desktop">
    <div class="body-inner">
        ...
        <?php echo $__env->make("frontend.layout.socialicon", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <script src="<?php echo e(asset("frontend/js/vendors.min.js")); ?>"></script>
        ...
        <script src="<?php echo e(asset("frontend/js/form-select2.min.js")); ?>"></script>
        ...
        <script src="https://apis.google.com/js/platform.js"></script>
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v16.0&appId=481054275414885" nonce="MWeZBjTc">
        </script>
...
<?php /**PATH D:\CEAA\ceaa\resources\views/frontend/layout/main.blade.php ENDPATH**/ ?>