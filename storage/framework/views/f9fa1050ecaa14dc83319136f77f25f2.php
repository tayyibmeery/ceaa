            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        <div class="mb-3">
                            <img src="<?php echo e(asset("storage/" . (auth()->user()->profile_picture ?? "default-profile.jpg"))); ?>" class="rounded-circle mb-3 border border-2" width="150" height="150" id="preview-image">
                        </div>
                        <div class="mb-3">
